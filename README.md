...
Details: [docs/strategy.md](docs/strategy.md) · **Visual map:** [docs/strategy-canvas.md](docs/strategy-canvas.md) · Agent playbook: [.cursor/skills/robinhood-delta-band-cc/SKILL.md](.cursor/skills/robinhood-delta-band-cc/SKILL.md)
...
| `docs/strategy-canvas.md` | Visual diagrams — sleeves, bands, daily flow, deployment |
