...
- **Deployment focus** ([docs/strategy.md](../../../docs/strategy.md)): compute `idle_cc_total`, `put_collateral`, `deployable_cash`; label **FILL-SLOTS / INDEX / MIXED / DEPLOY BLOCKED** and state the month’s bias in the report.
...
Slack daily-check: **two messages** per [docs/slack-automations.md](../../../docs/slack-automations.md) — (1) portfolio scoreboard **+ income sweep line**, (2) overlay actions + **deployment focus line** + CTA.
